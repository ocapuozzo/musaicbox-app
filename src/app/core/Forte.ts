...
export class Forte {
  ...
  private static _instance : Forte
  ...
  // {
  //   return Forte._instance || (Forte._instance = new this());
  // }

  static forteNum(pcs: IPcs) : string {
    return forteMap.get(pcs.cyclicPrimeForm().getPcsStr(true)) ?? ""
  }
