...
describe('Laboratory explorer', () => {
  ...
  it('Explore sub-group of musaic group', () => {
    ...
    let M5_T1 = new MusaicOperation(12, 5, 0);
    let M7_T1 = new MusaicOperation(12, 7, 0);
    let M11_T1 = new MusaicOperation(12, 11, 0);
    let CM1_T1 = new MusaicOperation(12, 1, 0, true);
    let CM5_T1 = new MusaicOperation(12, 5, 0, true);
    let CM7_T1 = new MusaicOperation(12, 7, 0, true);
    let CM11_T1 = new MusaicOperation(12, 11, 0, true);
    ...
    let generatorGroup = new Map<string, MusaicOperation[][]>()
